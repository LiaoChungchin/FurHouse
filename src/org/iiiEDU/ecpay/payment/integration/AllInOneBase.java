...
//			String paymentConfPath = "./src/main/resources/payment_conf.xml";
			String globalprojectimgpath = PathHandler.globalProjectImgPath;	
			String globalXMLgpath = 
					globalprojectimgpath.substring(0, globalprojectimgpath.indexOf("/FurHouse") + 9) + "/src/payment_conf.xml";
			String paymentConfPath = globalXMLgpath;
