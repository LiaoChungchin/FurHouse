									...
									<div class="row">
										<div class="col-md-12" id="box3-product">
											...
											<p class="card-text-dollar">
												好康價&nbsp;&nbsp;&nbsp;$NT<span class="price">${product.price}</span>
											</p>
									...
									<div class="row">
										<div class="col-md-12">
											...
											<div class="input-group">
												...
												</span> <input type='text' name='quantity' value='0' class='qty'>
												<span class="input-group-btn">
													<button type="button" class="btn btn-outline-secondary"
										...
										<div class="col-md-12">
											<div id="tabs">
												...
												<div id="tabs-1">
													...
													<p class="card-text">
														本店絕不會另外通知消費者交易失敗，或是付款錯誤，一些奇怪理由，要您去提款機做任何取消交易或轉帳的動作，請小心不要受騙。</p>
												</div>
												<div id="tabs-2">
													<p class="card-text">
