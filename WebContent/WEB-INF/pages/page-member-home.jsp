						...
						<div class="form-group row">
							...
							<div class="col-sm-9">
								<input type="text" readonly class="form-control-plaintext"
									id="adoptListId" name="adoptListId">
							</div>
						</div>
						<div class="form-group row">
							...
							<div class="col-sm-9">
								<input type="text" readonly class="form-control-plaintext"
									id="adoptListVisitTime" name="visitTime">
							</div>
						</div>
						<div class="form-group row">
			...
			.on(
					...
					function() {
						...
						case 2:
							$('.text-content')
									.html(
											'<div class="wrapper"></div></table><div class="pageGroup">');
...
// 	});
	...
	function writeHtml(adoptLists) {
		let tempstr = '<table class="table table-hover table-striped">'
				...
				+ '			<th scope="col">編號</th>' + '			<th scope="col">探望時間</th>'
				+ '			<th scope="col">貓編號</th>' + '			<th scope="col">貓名</th>'
				+ '			<th scope="col">狀態</th>' + '			<th scope="col">功能</th>'
				+ '		</tr>' + '	</thead>' + '	<tbody>';
